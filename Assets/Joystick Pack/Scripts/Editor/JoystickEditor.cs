...
{
    private SerializedProperty dependecyContainer;
    ...
    {
        dependecyContainer = serializedObject.FindProperty("dependencyContainer");
    ...
    {
        EditorGUILayout.PropertyField(dependecyContainer, new GUIContent("Dependency Container", "The distance the visual handle can move from the center of the joystick."));
